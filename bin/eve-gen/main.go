		...
		if config != "" {
			...
			case "evauth":
				...
				vars = map[string]interface{}{"Package": "main",
					...
					"USE_PROMETHEUS":         true,
					"USE_EVTOKEN":            true,
					"TOKEN_STORAGE_URL":      "http://127.0.0.1:9092/" + eve.VERSION + "/eve/evbolt",
					...
					"USE_EVLOG_API":          false,
					"USE_EVSESSION":          true,
					"SESSION_STORAGE_URL":    "http://127.0.0.1:9092/" + eve.VERSION + "/eve/evbolt",
					"SESSION_STORAGE_DB":     "sessions.db",
					"SESSION_STORAGE_BUCKET": "sessions",
					"USE_EVSECRET":           true,
					"SECRET_STORAGE_URL":     "http://127.0.0.1:9092/" + eve.VERSION + "/eve/evbolt",
					"SECRET_STORAGE_DB":      "secrets.db",
					"SECRET_STORAGE_BUCKET":  "secrets",
					"SECRET_ENC_KEY":         "TokenKeyEnc",
					"SECRET_SIG_KEY":         "TokenKeySig",
					"USE_EVUSER":             true,
					"USER_STORAGE_URL":       "http://127.0.0.1:9092/" + eve.VERSION + "/eve/evbolt",
			...
			case "evbolt":
				...
				vars = map[string]interface{}{"Package": "main",
					...
					"USE_EVLOG":              true,
					"EVLOG_URL":              "http://127.0.0.1:9091/" + eve.VERSION + "/eve/evlog",
					"USE_EVLOG_API":          false,
					"USE_EVSESSION":          false,
					"SESSION_STORAGE_URL":    "",
					"SESSION_STORAGE_DB":     "",
